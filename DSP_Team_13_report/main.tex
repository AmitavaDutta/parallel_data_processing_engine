...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Conceptualization \& Software Architecture:} Designed the core repository structure and the unified execution framework (\texttt{run\_experiment.py}).
